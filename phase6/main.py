...
def main():
    ...
    brain = Brain()
    speaker = Speaker()
    console.print("[bold green]BADSHAH-AI v2 Phase 6 Safe Apply ready[/bold green]")
    console.print("[yellow]Try: self modify add pricing section | show patches | apply latest patch | backup workspace[/yellow]")
