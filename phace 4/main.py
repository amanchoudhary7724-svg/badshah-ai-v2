...
def main():
    ...
    brain = Brain()
    speaker = Speaker()
    console.print("[bold green]BADSHAH-AI Phase 4 ready[/bold green]")
    console.print("Examples: create website portfolio | export workspace | tasks | browser scrape https://example.com")
