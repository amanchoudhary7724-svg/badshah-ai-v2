...
def main():
    ...
    brain = Brain()
    speaker = Speaker()
    console.print("[bold green]BADSHAH-AI v2 Phase 5 SelfMod ready[/bold green]")
    console.print("[yellow]Try: health check | self modify add dark mode | show patches | export workspace[/yellow]")
