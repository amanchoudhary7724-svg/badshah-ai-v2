...
class Settings:
    def __init__(self):
        ...
        self.google_send_enabled = bool_env("GOOGLE_SEND_ENABLED", False)
        self.prepare_dirs()
    def prepare_dirs(self):
        for p in [self.memory_db.parent, self.task_db.parent, self.safe_workspace, self.safe_workspace/"drafts", self.safe_workspace/"calendar", self.export_dir, self.log_file.parent]:
