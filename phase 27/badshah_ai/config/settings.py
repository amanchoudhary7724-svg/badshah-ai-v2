...
class Settings:
    def __init__(self):
        ...
        self.fast_model = os.getenv("FAST_MODEL", "llama3.2:1b")
        self.coding_model = os.getenv("CODING_MODEL", "qwen2.5-coder:1.5b")
        self.smart_model = os.getenv("SMART_MODEL", "llama3.2:3b")
        self.fallback_model = os.getenv("FALLBACK_MODEL", self.default_model)
    ...
    def prepare_dirs(self):
        for p in [self.memory_db.parent, self.task_db.parent, self.safe_workspace, self.export_dir, self.log_file.parent, self.plugin_dir, self.plugin_config.parent]:
