...
def browser_title(url):
    ...
    except Exception as e: return "Browser title error. Run scripts\\install_browser.bat. Error: " + str(e)
def browser_text(url):
    try: return asyncio.run(_page_text(url))
    except Exception as e: return "Browser text error. Run scripts\\install_browser.bat. Error: " + str(e)
def browser_screenshot(url):
    try: return asyncio.run(_screenshot(url))
    except Exception as e: return "Browser screenshot error. Run scripts\\install_browser.bat. Error: " + str(e)
