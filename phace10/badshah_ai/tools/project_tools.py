...
def create_static_website(name="badshah_site"):
    ...
    html = "<!doctype html><html><head><title>BADSHAH</title><link rel='stylesheet' href='style.css'></head><body><section><h1>BADSHAH Website</h1><p>v1.0 final ready.</p></section></body></html>"
